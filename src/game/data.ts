...
export const skillCost = (lvl: number) => Math.round(70 * Math.pow(1.32, Math.max(0, lvl - 1)));
...
/* ================= AFK REWARDS ================= */
export const AFK_REWARDS_CONFIG = {
  maxOfflineHours: 12,
  baseRewardPerHour: { gold: 500, xp: 100 },
  rareChanceBase: 0.05,
  rareChanceMax: 0.25,
  choicesCount: 3,
};

export const AFK_REWARD_POOL = [
  { type: "gold", weight: 40, min: 500, max: 2000 },
  { type: "xp", weight: 30, min: 100, max: 500 },
  { type: "gems", weight: 10, min: 1, max: 5 },
...
export const BATTLE_PASS_QUESTS_DAILY = [
  { id: "kill_monsters", desc: "Убейте 100 монстров", xp: 50 },
  { id: "complete_zones", desc: "Пройдите 5 зон", xp: 40 },
  { id: "deal_damage", desc: "Нанесите 1M урона", xp: 60 },
  { id: "upgrade_gear", desc: "Улучшите предмет 3 раза", xp: 30 },
];

export const BATTLE_PASS_QUESTS_WEEKLY = [
  { id: "boss_kills", desc: "Убейте 10 боссов", xp: 200 },
  { id: "prestige", desc: "Сделайте престиж", xp: 300 },
  { id: "duel_wins", desc: "Победите в 5 дуэлях", xp: 150 },
  { id: "guild_donation", desc: "Пожертвуйте в гильдию 10к золота", xp: 100 },
  { id: "tower_floor", desc: "Достигните 50 этажа башни", xp: 250 },
];
...
export const SOCIAL_CONFIG = {
  ...
  referrerBonusPct: 10,
  referralRewardGems: 50,
};

/* ================= BESTIARY ================= */
export const BESTIARY_ENTRIES = [
  { id: "slime", name: "Слизень", icon: "blob", killsNeeded: [10, 50, 100, 500], bonus: { dmgPct: 1 } },
  { id: "goblin", name: "Гоблин", icon: "goblin", killsNeeded: [10, 50, 100, 500], bonus: { goldPct: 2 } },
  { id: "orc", name: "Орк", icon: "orc", killsNeeded: [10, 50, 100, 500], bonus: { hpPct: 2 } },
  { id: "skeleton", name: "Скелет", icon: "skeleton", killsNeeded: [10, 50, 100, 500], bonus: { armor: 5 } },
  { id: "demon", name: "Демон", icon: "demon", killsNeeded: [10, 50, 100, 500], bonus: { crit: 1 } },
  { id: "dragon", name: "Дракон", icon: "dragon", killsNeeded: [5, 25, 50, 250], bonus: { dmgPct: 3 } },
  { id: "angel", name: "Ангел", icon: "angel", killsNeeded: [5, 25, 50, 250], bonus: { regen: 1 } },
  { id: "void_walker", name: "Идущий в Пустоте", icon: "void", killsNeeded: [3, 10, 25, 100], bonus: { xpPct: 5 } },
];
