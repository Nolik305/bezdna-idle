...
export function BattleScreen() {
  ...
  useEffect(() => {
    ...
    if (f && f.id !== lastFx.current) {
      ...
      if (target) { target.classList.remove("anim-shake", "anim-lunge-left", "anim-lunge-right"); void target.offsetWidth; target.classList.add("anim-shake"); }
      ...
      // Добавляем анимацию урона для героя
      if (f.kind === "hurt" && heroRef.current) {
        ...
        <div className="relative h-52 flex items-end justify-center gap-2 px-5">
          {e && (
            <>
              ...
              <div ref={heroRef} className="relative z-10 w-24 h-32 shrink-0 anim-battle-idle hero-idle">
